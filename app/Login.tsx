    ...
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.formCard}>
        <View style={styles.tabRow}>
          ...
          <TouchableOpacity style={styles.tabBtn} onPress={() => router.replace('/SignUp')}>
        ...
        <View style={styles.inputGroup}>
          ...
          <View style={styles.inputField}>
            ...
            <TextInput placeholder="Email" style={styles.input} placeholderTextColor="#888" />
          </View>
        </View>
        <View style={styles.inputGroup}>
          ...
          <View style={styles.inputField}>
            ...
            <TextInput placeholder="Password" style={styles.input} placeholderTextColor="#888" secureTextEntry={!showPassword} />
